...
def quick_start(model, dataset, config_dict, save_model=True):
    ...
    # hyper-parameters
    hyper_ls = []
    # Debug: print current hyper_parameters
    print(f"DEBUG: hyper_parameters before processing: {config['hyper_parameters']}")
    if "seed" not in config['hyper_parameters']:
        config['hyper_parameters'] = ['seed'] + config['hyper_parameters']
    print(f"DEBUG: hyper_parameters after processing: {config['hyper_parameters']}")
